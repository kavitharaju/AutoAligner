...
cd Scripts
# python3 DB_manipulations.py read $srctable ../Resources/$src.cleaned_bible.txt

# python3 Preprocessor.py $src ../Resources/$src.cleaned_bible.txt $stopword $stemming $namedentity
...
# echo "greek"
# python3 DB_manipulations.py read $trgtable ../Resources/$trg.cleaned_bible.txt -strongs
# else
#  if [ "$trg" = "heb" ]
#  then
#  	echo "hebrew"
#  	python3 DB_manipulations.py read $trgtable ../Resources/$trg.cleaned_bible.txt -strongs
#  else
# 	echo "non-greek. non-hebrew"
# 	python3 DB_manipulations.py read $trgtable ../Resources/$trg.cleaned_bible.txt
#  fi
# fi
# python3 Preprocessor.py $trg ../Resources/$trg.cleaned_bible.txt $stopword $stemming $namedentity
